  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      <div className="relative">
        ...
        <div className="absolute -left-2 top-1/2 w-2 h-2 bg-herbalife-400 rounded-full animate-pulse"></div>
        <div className="absolute -right-2 top-1/2 w-2 h-2 bg-herbalife-400 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
      </div>
      
      {showText && (
        <div className="flex flex-col">
          <span className="text-lg font-bold text-herbalife-700 dark:text-herbalife-300 tracking-wider">
            HERBAFLOW
          </span>
          <span className="text-xs text-herbalife-600 dark:text-herbalife-400 tracking-wide">
            SMART INVENTORY
          </span>
        </div>
      )}
